...
urlpatterns = [
    ...
    path("open-draft/", views.open_draft, name="open_draft"),
    path("submit-draft/", views.submit_draft, name="submit_draft"),
    path("reject-draft/", views.reject_draft, name="reject_draft"),
    path("discard-draft/", views.discard_draft, name="discard_draft"),
    path("draft-review/", views.draft_review, name="draft_review"),
    path("approve-draft/", views.publish_draft, name="publish_draft"),
    path("notify-drivers/", views.notify_drivers, name="notify_drivers"),
    ...
    path(
        "overnight-flight-check/",
        overnight_views.overnight_flight_check,
        name="overnight_flight_check",
    ),
    path(
        "confirm-overnight/<str:token>/",
        overnight_views.overnight_confirm_public,
        name="overnight_confirm_public",
    ),
    path(
        "overnight-staff-confirm/",
        overnight_views.overnight_staff_confirm,
        name="overnight_staff_confirm",
    ),
    ...
    path("my-schedule/timeoff/", ops_views.my_timeoff_action, name="my_timeoff_action"),
