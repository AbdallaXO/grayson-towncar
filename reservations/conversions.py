...
def send_capi_event(event_name, user_data, custom_data=None, request=None):
    if not FB_PIXEL_ID or not FB_CAPI_ACCESS_TOKEN:
        logger.error("Missing required environment variables: FB_PIXEL_ID or FB_CAPI_ACCESS_TOKEN")
        return None
    ...
    event_payload = {
        ...
        "event_source_url": request.build_absolute_uri() if request else "https://your-production-url.com",
        "user_data": user_data,
    }
